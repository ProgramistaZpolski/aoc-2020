...
for (let index = 0; index < processedInput.length; index++) {
    ...
    if (tmpElement[1].charAt(parseInt(tmp3Element[0])) == tmp2Element[1]) {
        if (tmpElement[1].charAt(parseInt(tmp3Element[1])) != tmp2Element[1]) {
            count++;
        }
    } else if (tmpElement[1].charAt(parseInt(tmp3Element[1])) == tmp2Element[1]) {
        if (tmpElement[1].charAt(parseInt(tmp3Element[0])) != tmp2Element[1]) {
            count++;
        }
    }
